...
biocLite("BiocGenerics", ask=FALSE, lib=instLib)
biocLite("poweRlaw", ask=FALSE, lib=instLib)
biocLite("S4Vectors", ask=FALSE, lib=instLib)
biocLite("IRanges", ask=FALSE, lib=instLib)
biocLite("GenomeInfoDb", ask=FALSE, lib=instLib)
biocLite("zlibbioc", ask=FALSE, lib=instLib)
biocLite("XVector", ask=FALSE, lib=instLib)
biocLite("RColorBrewer", ask=FALSE, lib=instLib)
biocLite("GenomicRanges", ask=FALSE, lib=instLib)
